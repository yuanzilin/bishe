    ...
    doRegister() {
      if (!this.user.username) {
        ...
        if (!reg.test(this.user.email)) {
          ...
          param.append('type',"developer")
          param.append('username',this.user.username)
          param.append('password',this.user.password)
          param.append('email',this.user.email)
          param.append('invitation',this.user.invitation)
          console.log(16616166166,param.get("type"))
          console.log(16616166166,param.get("username"))
          console.log(16616166166,param.get("password"))
          console.log(16616166166,param.get("email"))
          console.log(16616166166,param.get("invitation"))
          axios
